...
const char* WinDX11Dialog::FileDialog(void* data, char* extName, const char* ext, bool open)
{
	char curDir[512];
...
bool WinDX11Dialog::ColorDialog(void* data, float* color)
{
